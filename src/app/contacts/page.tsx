    ...
    return (
        <main className="container min-h-screen py-12" style={{ backgroundColor: background, color: foreground }}>
            ...
            <section className="py-16 px-6 md:px-16" data-aos="fade-up">
                <h1 className="text-3xl md:text-4xl font-bold text-center mb-12" style={{ color: primary }}>
                    Curie
                </h1>

                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
                    {[ 
                        { title: "Chancelier", mail: "sandjo50@yahoo.fr", tel: "" },
                        { title: "Économe", mail: "", tel: "+237 698 12 52 58" },
                        { title: "Secrétaire", mail: "Fabianadoume@gmail.com", tel: "" },
                    ].map((person, i) => (
                        <div
                            key={i}
                        ...
                        >
                            ...
                            <div className="flex flex-col gap-3 text-primary font-bold">
                                {person.mail && (
                    ...
                    >
                        ...
                        <ul className="space-y-3">
                            <li className="flex items-center gap-3">
                                ...
                                <span>De la pastorale — </span>
                            </li>

                            <li className="flex items-center gap-3">
                                <Mail size={20} className="text-primary" />
                                <span>Des catéchistes — </span>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <section className="py-20 px-6 md:px-16" data-aos="fade-up">
                ...
                <div className="grid md:grid-cols-3 gap-10">
                    {[ 
                        { name: "SEDUC", desc: "Service diocésain de l’éducation catholique", mail: "" },
                        { name: "Coordination de Santé", desc: "Réseau des structures sanitaires diocésaines", mail: "Anuncjata@gmail.com" },
                        { name: "CARITAS", desc: "Œuvre caritative du diocèse", mail: "Fabianadoume@gmail.com" },
                    ].map((structure, i) => (
                        <div
                            key={i}
                            className="rounded-2xl p-6 shadow-lg backdrop-blur-md border border-primary/50 transition hover:shadow-xl"
